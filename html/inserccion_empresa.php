<?php
    ...
    if($_POST['empresa'] != "" && isset($_POST['empresa']) && $_POST['direccion'] != "" && isset($_POST['direccion']) && $_POST['pais'] != "" && isset($_POST['pais']) && $_POST['town'] != "" && isset($_POST['town']) && $_POST['cp'] != "" && isset($_POST['cp']) && $_POST['activ'] != "" && isset($_POST['activ'])){
        $datos_empresa = true;
    }
